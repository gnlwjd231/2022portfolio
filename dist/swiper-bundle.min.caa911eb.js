...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/swiper/swiper-bundle.min.js":[function(require,module,exports) {
var define;
...
!function (e, t) {
  ...
  const re = [function (e) {
    ...
    function b() {
      ...
      const a = t.$wrapperEl,
            r = a.attr("id") || "swiper-wrapper-".concat((n = 16, void 0 === n && (n = 16), "x".repeat(n).replace(/x/g, () => Math.round(16 * Math.random()).toString(16))));
      var n;
    ...
    function o(e) {
      ...
      if (t.params.slidesPerView > 1 && !t.params.centeredSlides && (n = t.params.slidesPerView), t.params.thumbs.multipleActiveThumbs || (n = 1), n = Math.floor(n), s.slides.removeClass(l), s.params.loop || s.params.virtual && s.params.virtual.enabled) for (let e = 0; e < n; e += 1) s.$wrapperEl.children("[data-swiper-slide-index=\"".concat(t.realIndex + e, "\"]")).addClass(l);else for (let e = 0; e < n; e += 1) s.slides.eq(t.realIndex + e).addClass(l);
    }
    ...
    s({
      ...
      setTranslate: () => {
        ...
        for (let e = 0; e < a.length; e += 1) {
          ...
          const v = "rotateX(".concat(p ? 0 : -i, "deg) rotateY(").concat(p ? i : 0, "deg) translate3d(").concat(h, "px, ").concat(f, "px, ").concat(g, "px)");

          if (o <= 1 && o > -1 && (m = 90 * s + 90 * o, n && (m = 90 * -s - 90 * o)), t.transform(v), c.slideShadows) {
            let e = p ? t.find(".swiper-slide-shadow-left") : t.find(".swiper-slide-shadow-top"),
                s = p ? t.find(".swiper-slide-shadow-right") : t.find(".swiper-slide-shadow-bottom");
            0 === e.length && (e = d("<div class=\"swiper-slide-shadow-".concat(p ? "left" : "top", "\"></div>")), t.append(e)), 0 === s.length && (s = d("<div class=\"swiper-slide-shadow-".concat(p ? "right" : "bottom", "\"></div>")), t.append(s)), e.length && (e[0].style.opacity = Math.max(-o, 0)), s.length && (s[0].style.opacity = Math.max(o, 0));
          }
        }
    ...
    s({
      ...
      setTranslate: () => {
        ...
        for (let i = 0; i < e.length; i += 1) {
          ...
          const u = "translate3d(".concat(c, "px, ").concat(p, "px, 0px) rotateX(").concat(d, "deg) rotateY(").concat(o, "deg)");
          se(a, r).transform(u);
        }
      },
      setTransition: e => {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","node_modules/swiper/swiper-bundle.min.js"], null)
//# sourceMappingURL=/swiper-bundle.min.caa911eb.js.map